    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity
        style={[
          ...
          locale === 'English' && styles.selectedLanguage
        ]}
        onPress={() => changeLanguage('English')}
      >
        <Text style={[
          styles.languageText,
          locale === 'English' && styles.selectedLanguageText
        ]}>
          {t('english')}
        </Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        style={[
          styles.languageButton,
          locale === 'हिंदी' && styles.selectedLanguage
        ]}
        onPress={() => changeLanguage('हिंदी')}
      >
        <Text style={[
          styles.languageText,
          locale === 'हिंदी' && styles.selectedLanguageText
        ]}>
          {t('hindi')}
        </Text>
      </TouchableOpacity>
